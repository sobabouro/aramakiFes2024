...
public class LinkedPolygon {
    ...
    /// 切断平面の法線方向を "A", ポリゴンの法線方向を "B", 切断辺 (NewVertexInfo, NewVertexInfo) の方向を "C" とする
    ...
    public void MakePolygon(
        ...
        NewVertexInfo toward = First.Value.NewEdgeToward;
        NewVertexInfo away = Last.Value.NewEdgeAway;
