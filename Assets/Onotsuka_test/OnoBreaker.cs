...
public class OnoBreaker : MonoBehaviour {
    // 固有ステータス
    ...
    public void Attack(Collision collision) {
        OnoBreakable breakable = collision.gameObject.GetComponent<OnoBreakable>();
        ...
        // 最低速度未満ならダメージは発生しない
        if (relative_velocity_magnitude < _minimumSpeedNeededForDamage)
            return;
